import { BASE_ACCOUNT_CREATION_COST, STORAGE_BYTE_COST, } from '@massalabs/massa-web3';
/**
 ...
 */
export function calculateMaxCoins(contractByteCodeSize, coinsSent) {
    return (BASE_ACCOUNT_CREATION_COST +
 ...
 *
 */
export function calculateBytecodeSize(contracts) {
    return contracts.reduce((acc, contract) => acc + BigInt(contract.data.length), 0n);
}
/**
 ...
 *
 */
export function calculateCoinsSent(contracts) {
    return contracts.reduce((acc, contract) => acc + contract.coins, 0n);
}
//# sourceMappingURL=maxCoins.js.map