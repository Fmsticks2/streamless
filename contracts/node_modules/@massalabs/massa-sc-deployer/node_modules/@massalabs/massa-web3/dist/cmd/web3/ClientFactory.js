...
class ClientFactory {
     ...
     */
    static async createDefaultClient(provider, chainId, retryStrategyOn = true, baseAccount) {
        ...
        let account = null;
        if (baseAccount) {
            account = new Web3Account_1.Web3Account(baseAccount, publicApi, chainId);
        }
     ...
     * @returns A promise that resolves to a Client object.
     */
    static async createCustomClient(providers, chainId, retryStrategyOn = true, baseAccount) {
        let clientConfig = {
            retryStrategyOn,
            providers,
        };
