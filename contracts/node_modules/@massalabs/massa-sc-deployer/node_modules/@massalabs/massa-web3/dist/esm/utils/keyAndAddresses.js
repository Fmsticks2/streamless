import { base58Encode, varintEncode, varintDecode, hashBlake3, base58Decode, } from './Xbqcrypto';
import * as ed from '@noble/ed25519';
import { getBytesPublicKey, getBytesSecretKey } from './bytes';
import { ADDRESS_CONTRACT_PREFIX, ADDRESS_PREFIX_LENGTH, ADDRESS_USER_PREFIX, PUBLIC_KEY_PREFIX, } from '@massalabs/web3-utils';
/**
 * A secret key.
...
export class Address {
    ...
    setDecodedVersionAndAddressBytes() {
        ...
        this.versionAndAddressBytes = new Uint8Array(base58Decode(versionAndAddress));
    }
    setVersion() {
        const { value, bytes: versionBytesLength } = varintDecode(this.versionAndAddressBytes);
        this.version = value;
    ...
    static fromPublicKey(publicKey) {
        ...
        const base58Encoded = ADDRESS_USER_PREFIX +
