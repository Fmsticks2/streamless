...
export declare class WalletClient extends BaseClient implements IWalletClient {
     ...
     */
    signMessage(data: string | Buffer, chainId: bigint, accountSignerAddress: string): Promise<ISignature>;
    /**
     ...
     */
    verifySignature(data: string | Buffer, signature: ISignature): Promise<boolean>;
    /**
