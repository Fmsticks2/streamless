...
export declare class SmartContractsClient extends BaseClient implements ISmartContractsClient {
     ...
     * @returns A promise that resolves to the status of the operation.
     */
    awaitRequiredOperationStatus(opId: string, requiredStatus: EOperationStatus, timeout?: number): Promise<EOperationStatus>;
    /**
     ...
     * @returns A promise that resolves to the status of the operation.
     */
    awaitMultipleRequiredOperationStatus(opId: string, requiredStatuses: EOperationStatus[], timeout?: number): Promise<EOperationStatus>;
    /**
     ...
     *
     */
    private awaitOperationStatusHelper;
}
