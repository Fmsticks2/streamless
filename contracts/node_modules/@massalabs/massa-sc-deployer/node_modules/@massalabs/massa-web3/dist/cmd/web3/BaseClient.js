...
exports.BaseClient = exports.PERIOD_OFFSET = exports.requestHeaders = void 0;
...
const encodeAddressToBytes = (address, isSmartContract = false) => {
    let targetAddressEncoded = (0, Xbqcrypto_1.base58Decode)(address.slice(2));
...
class BaseClient {
    ...
    setProviders(providers) {
        const hasPublicProvider = providers.some((provider) => provider.type === IProvider_1.ProviderType.PUBLIC);
    ...
    async promisifyJsonRpcCall(resource, params) {
        ...
        try {
            resp = await axios_1.default.post(this.getProviderForRpcMethod(resource).url, body, exports.requestHeaders);
        }
        catch (ex) {
            return {
                isError: true,
    ...
    compactBytesForOperation(data, opTypeId, expirePeriod) {
        ...
        switch (opTypeId) {
            case OperationTypes_1.OperationTypeId.ExecuteSC: {
                ...
                // max coins amount
                const maxCoinEncoded = buffer_1.Buffer.from((0, Xbqcrypto_1.varintEncode)(data.maxCoins));
                // contract data
            ...
            case OperationTypes_1.OperationTypeId.CallSC: {
                ...
                let serializedParam; // serialized parameter
