...
export function getBytesSecretKey(secretKey) {
    ...
    const secretKeyBase58Decoded = base58Decode(secretKey.slice(SECRET_KEY_PREFIX_LENGTH));
...
export function getBytesPublicKey(publicKey) {
    ...
    const publicKeyBase58Decoded = base58Decode(publicKey.slice(PUBLIC_KEY_PREFIX_LENGTH));
