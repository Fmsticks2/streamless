...
export declare class ClientFactory {
     ...
     */
    static createDefaultClient(provider: DefaultProviderUrls, chainId: bigint, retryStrategyOn?: boolean, baseAccount?: IAccount): Promise<Client>;
    /**
     ...
     * @returns A promise that resolves to a Client object.
     */
    static createCustomClient(providers: Array<IProvider>, chainId: bigint, retryStrategyOn?: boolean, baseAccount?: IAccount): Promise<Client>;
    /**
