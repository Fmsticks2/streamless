...
import { Args, fromMAS, MAX_GAS_CALL, } from '@massalabs/web3-utils';
...
export class SmartContractsClient extends BaseClient {
    ...
    async callSmartContract(callData, executor) {
        ...
        if (callData.maxGas > MAX_GAS_CALL) {
            throw new Error(`The gas submitted ${callData.maxGas.toString()} exceeds the max. allowed block gas of ${MAX_GAS_CALL.toString()}`);
        }
    ...
    async readSmartContract(readData) {
        ...
        if (readData.maxGas > MAX_GAS_CALL) {
            throw new Error(`The gas submitted ${readData.maxGas.toString()} exceeds the max. allowed block gas of ${MAX_GAS_CALL.toString()}`);
        }
