...
class WalletClient extends BaseClient_1.BaseClient {
    ...
    static async walletGenerateNewAccount() {
        ...
        const version = Buffer.from((0, Xbqcrypto_1.varintEncode)(web3_utils_1.KEYS_VERSION_NUMBER));
        const secretKeyBase58Encoded = web3_utils_1.SECRET_KEY_PREFIX +
     ...
     */
    async signMessage(data, chainId, accountSignerAddress) {
        ...
        if (!signerAccount) {
            ...
            account = new Web3Account_1.Web3Account(signerAccount, this.publicApiClient, chainId);
        }
    ...
    async verifySignature(data, signature) {
        ...
        const publicKey = keyAndAddresses_1.PublicKey.fromString(signature.publicKey);
        ...
        try {
            ...
            if (publicKey.bytes.length != 32) {
                throw new Error(`Invalid public key length. Expected 32, got ${publicKey.bytes.length}`);
            }
            // verify signature.
