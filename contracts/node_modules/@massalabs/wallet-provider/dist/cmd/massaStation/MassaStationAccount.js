...
class MassaStationAccount {
    ...
    async sign(data) {
        ...
        try {
            signOpResponse = await (0, RequestHandler_1.postRequest)(`${MassaStationProvider_1.MASSA_STATION_ACCOUNTS_URL}/${this._name}/signMessage`, signData);
        }
        catch (ex) {
        ...
        const signature = (0, bs58check_1.encode)(Buffer.from(signOpResponse.result.signature, 'base64'));
        return {
