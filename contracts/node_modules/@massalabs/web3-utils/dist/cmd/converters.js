...
exports.MassaUnits = exports.toMAS = exports.fromMAS = exports.MASSA_SCALING_FACTOR = void 0;
const tslib_1 = require("tslib");
const bignumber_js_1 = tslib_1.__importDefault(require("bignumber.js"));
exports.MASSA_SCALING_FACTOR = 9;
/**
...
const fromMAS = (amountInMassa) => {
    ...
    const scaleFactor = new bignumber_js_1.default(10).pow(new bignumber_js_1.default(exports.MASSA_SCALING_FACTOR));
...
const toMAS = (amountInNanoMassa) => {
    ...
    return new bignumber_js_1.default(amountScaled.toFixed(exports.MASSA_SCALING_FACTOR));
};
exports.toMAS = toMAS;
/**
