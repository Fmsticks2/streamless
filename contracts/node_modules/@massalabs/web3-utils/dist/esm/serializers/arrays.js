...
import { Args, ArrayTypes } from '../arguments';
import { bytesToStr } from './strings';
import { byteToBool } from './bool';
import { byteToU8, bytesToF32, bytesToF64, bytesToI32, bytesToI64, bytesToU32, bytesToU64, } from './numbers';
...
export function serializableObjectsArrayToBytes(source) {
    return source.reduce((acc, curr) => Args.concatArrays(acc, curr.serialize()), new Uint8Array(0));
}
/**
